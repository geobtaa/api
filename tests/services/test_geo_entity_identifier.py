...
class TestGeoEntityIdentifier:
    ...
    def test_construct_geo_entity_prompt_basic(self):
        ...
        identifier = GeoEntityIdentifier("test-key", "gpt-3.5-turbo", "https://api.openai.com/v1/chat/completions")
    ...
    async def test_enrich_with_gazetteer_empty_entities(self):
        ...
        gazetteer_service = MagicMock()
        identifier = GeoEntityIdentifier("test-key", "gpt-3.5-turbo", "https://api.openai.com/v1/chat/completions", gazetteer_service)
    ...
    async def test_enrich_with_gazetteer_partial_match(self):
        ...
        entities = [
            {"name": "Minnesota", "type": "state", "context": "Midwestern state"}
        ]
    ...
    async def test_enrich_with_gazetteer_error_handling(self):
        ...
        entities = [
            {"name": "Test City", "type": "city", "context": "Test"}
        ]
