...
class TestImageService:
    ...
    def test_init_with_various_metadata_types(self):
        ...
        test_cases = [
            {"id": "simple-doc"},
            {"id": "doc-with-refs", "dct_references_s": '{"http://schema.org/thumbnailUrl": "http://example.com/thumb.jpg"}'},
...
class TestImageServiceThumbnailSourceURL:
    ...
    def test_get_thumbnail_source_url_schema_thumbnail(self):
        ...
        try:
            ...
            references_list = {
                "http://schema.org/thumbnailUrl": ["http://example.com/thumb1.jpg", "http://example.com/thumb2.jpg"]
            }
    ...
    def test_get_thumbnail_source_url_contentdm_transform(self):
        ...
        try:
            ...
            result = service._get_thumbnail_source_url(references)
            assert "cdm16022.contentdm.oclc.org/iiif/2/collection123:456/full/200,/0/default.jpg" in result
    ...
    def test_get_thumbnail_source_url_esri_services(self):
        ...
        try:
            ...
            test_cases = [
                ...
                ("urn:x-esri:serviceType:ArcGIS#TiledMapLayer", "http://example.com/arcgis/rest/services/test2"),
                ("urn:x-esri:serviceType:ArcGIS#DynamicMapLayer", "http://example.com/arcgis/rest/services/test3")
            ]
    ...
    def test_get_thumbnail_source_url_tms(self):
        ...
        try:
            ...
            result = service._get_thumbnail_source_url(references)
            assert result == "http://example.com/tms/reflect?format=application/vnd.google-earth.kml+xml"
...
class TestImageServiceThumbnailURL:
    ...
    def test_get_thumbnail_url_restricted_access(self):
        ...
        metadata = {
            ...
            "dct_references_s": json.dumps({"http://schema.org/thumbnailUrl": "http://example.com/thumb.jpg"})
        }
                            ...
                            "images": [
                                {
                                    "resource": {
                                        ...
                                        "service": {
                                            "@id": "http://example.com/iiif/service"
                                        }
                                    }
                                }
                            ]
                    ...
                    "items": [
                        {
                            "items": [
                                {
                                    "id": "http://example.com/direct-id.jpg"
                                }
                            ]
                        }
                    ]
...
class TestImageServiceCacheInteractions:
    ...
    def test_thumbnail_url_cache_hit_scenario(self):
        ...
        try:
            ...
            thumbnail_url = service._get_thumbnail_source_url({"http://schema.org/thumbnailUrl": "http://example.com/thumb.jpg"})
    ...
    def test_thumbnail_url_cache_miss_scenario(self):
        ...
        metadata = {
            "id": "test-doc",
            "dct_references_s": json.dumps({"http://schema.org/thumbnailUrl": "http://example.com/new-thumb.jpg"})
        }
    ...
    def test_queue_thumbnail_processing_with_real_service(self):
        ...
        try:
            ...
            try:
                ...
                assert "connection" in str(e).lower() or "worker" in str(e).lower() or "task" in str(e).lower()
    ...
    def test_logging_statements_execution(self):
        ...
        try:
            ...
            service._get_thumbnail_source_url({"http://schema.org/thumbnailUrl": "http://example.com/thumb.jpg"})
...
class TestImageServiceEdgeCases:
    ...
    def test_references_as_non_dict_non_string(self):
        ...
        metadata = {
            "id": "test-doc",
            "dct_references_s": ["invalid", "reference", "format"]
        }
    ...
    def test_complex_reference_structures(self):
        ...
        metadata = {
            "id": "test-doc",
            "dct_references_s": json.dumps(complex_references)
        }
    ...
    def test_wms_thumbnail_generation(self):
        ...
        for metadata_case in test_cases:
            ...
            try:
                ...
                references = {"http://www.opengis.net/def/serviceType/ogc/wms": "http://example.com/wms"}
                result = service._get_thumbnail_source_url(references)
