        ...
        with patch('requests.get') as mock_get:
            ...
            with patch('tempfile.mkdtemp') as mock_mkdtemp:
                ...
                with patch('tempfile.NamedTemporaryFile') as mock_temp:
                    ...
                    mock_get.assert_called_once_with("https://example.com/test.shp", verify=False, timeout=30)
...
class TestShapefileService:
    ...
    async def test_query_shapefile_success(self):
        ...
        mock_duckdb_service.ensure_table.assert_called_once_with(mock_con, "https://example.com/test.shp")
    ...
    async def test_preview_shapefile_success(self):
        ...
        with patch.object(ShapefileService, 'query_shapefile', new_callable=AsyncMock) as mock_query:
            ...
            assert result == expected_page
            mock_query.assert_called_once_with("https://example.com/test.shp", "", limit=10, offset=0)
