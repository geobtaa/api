...
class TestParseReferences:
    ...
    def test_parse_references_with_dict_and_invalid_json_string(self):
        ...
        document = {"dct_references_s": "invalid json{", "locn_geometry": "POINT(-93.2650 44.9778)"}
    ...
    def test_parse_references_with_dict_and_no_references(self):
        ...
        document = {"locn_geometry": "POINT(-93.2650 44.9778)"}
    ...
    def test_parse_references_with_dict_and_no_geometry(self):
        ...
        document = {"dct_references_s": '{"iiif": "http://example.com/iiif"}'}
...
class TestCreateViewerAttributes:
    ...
    def test_create_viewer_attributes_with_dict(self, mock_item_viewer):
        ...
        mock_viewer.viewer_geometry.return_value = {
            "type": "Point",
...
class TestViewerService:
    ...
    def test_get_viewer_attributes_success(self):
        ...
        service.viewer.viewer_geometry = MagicMock(
            return_value={"type": "Point", "coordinates": [-93.2650, 44.9778]}
        )
    ...
    def test_get_viewer_attributes_various_protocols(self):
        ...
        for protocol in protocols:
            ...
            service.viewer.viewer_endpoint = MagicMock(
                return_value=f"http://example.com/{protocol}"
            )
    ...
    def test_get_viewer_attributes_with_complex_geometry(self):
        ...
        complex_geometry = {
            "type": "Polygon",
            "coordinates": [
                [[-93.3, 44.9], [-93.2, 44.9], [-93.2, 45.0], [-93.3, 45.0], [-93.3, 44.9]]
            ],
        }
    ...
    def test_viewer_service_with_none_references(self):
        ...
        document = {"dct_references_s": None, "locn_geometry": "POINT(-93.2650 44.9778)"}
