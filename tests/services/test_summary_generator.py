...
class TestSummaryGenerator:
    ...
    def test_construct_summary_prompt_with_asset_content(self):
        ...
        metadata = {"title": "Minnesota Counties Map", "creator": "Jane Doe", "date": "1890"}

        asset_content = (
            "This map shows all 87 counties in Minnesota with their boundaries and county seats."
        )
    ...
    def test_construct_summary_prompt_complex_metadata(self):
        ...
        metadata = {
            ...
            "spatial": {"bbox": [-97.5, 43.0, -89.0, 49.5], "center": [-93.25, 46.25]},
    ...
    async def test_generate_summary_success(self):
        ...
        metadata = {"title": "Minnesota Historical Map", "creator": "John Doe", "date": "1880"}
    ...
    async def test_generate_summary_empty_response(self):
        ...
        mock_response_data = {"choices": [{"message": {"content": ""}}]}
