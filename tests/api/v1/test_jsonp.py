...
class TestDatetimeHandler:
    ...
    def test_datetime_handler_with_non_datetime(self):
        ...
        with pytest.raises(
            TypeError, match="Object of type <class 'int'> is not JSON serializable"
        ):
    ...
    def test_datetime_handler_with_list(self):
        ...
        with pytest.raises(
            TypeError, match="Object of type <class 'list'> is not JSON serializable"
        ):
    ...
    def test_datetime_handler_with_dict(self):
        ...
        with pytest.raises(
            TypeError, match="Object of type <class 'dict'> is not JSON serializable"
        ):
