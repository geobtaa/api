...
class TestShapefileEndpointsWithMocking:
    ...
    def test_query_endpoint_success(self, client, mock_service):
        ...
        mock_service.query_shapefile.assert_called_once_with(
            "https://example.com/test.shp", 
            "id>0"
        )
    ...
    def test_query_endpoint_with_callback(self, client, mock_service):
        ...
        response = client.get("/shapefiles/query?s3_uri=https://example.com/test.shp&sql=id>0&callback=myCallback")
    ...
    def test_query_endpoint_duckdb_error(self, client, mock_service):
        ...
        mock_service.query_shapefile = AsyncMock(side_effect=DuckDBConnectionError("DuckDB not available"))
    ...
    def test_query_endpoint_download_error(self, client, mock_service):
        ...
        mock_service.query_shapefile = AsyncMock(side_effect=ShapefileDownloadError("Download failed"))
    ...
    def test_schema_endpoint_success(self, client, mock_service):
        ...
        expected_schema = [
            {"column_name": "id", "column_type": "INTEGER", "null": "NO", "key": "PRI", "default": None, "extra": ""},
            {"column_name": "name", "column_type": "VARCHAR", "null": "YES", "key": "", "default": None, "extra": ""}
        ]
    ...
    def test_schema_endpoint_with_callback(self, client, mock_service):
        ...
        response = client.get("/shapefiles/schema?s3_uri=https://example.com/test.shp&callback=myCallback")
    ...
    def test_schema_endpoint_error(self, client, mock_service):
        ...
        mock_service.get_shapefile_schema = AsyncMock(side_effect=ShapefileProcessingError("Schema error"))
    ...
    def test_preview_endpoint_with_callback(self, client, mock_service):
        ...
        response = client.get("/shapefiles/preview?s3_uri=https://example.com/test.shp&callback=myCallback")
    ...
    def test_preview_endpoint_error(self, client, mock_service):
        ...
        mock_service.preview_shapefile = AsyncMock(side_effect=ShapefileDownloadError("Download failed"))
