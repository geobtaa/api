...
class DuckDBService(ABC):
    ...
    @abstractmethod
    def execute_query(self, con: Any, table_name: str, sql: str, limit: Optional[int] = None, offset: int = 0) -> Page:
...
class ShapefileService:
    ...
    async def query_shapefile(self, s3_uri: str, sql: str, limit: Optional[int] = None, offset: int = 0) -> Page:
