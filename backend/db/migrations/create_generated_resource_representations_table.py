...
from db.models import generated_resource_representations, metadata  # noqa: E402
...
def create_generated_resource_representations_table() -> None:
    """Create durable storage for generated JSON:API resource representations."""
    ...
    logger.info(
        "Ensuring generated_resource_representations table via metadata.create_all()..."
    )
    _ = generated_resource_representations
    ...
    logger.info("generated_resource_representations table ready")
